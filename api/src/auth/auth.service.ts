...
export class AuthService {
    ...
    async register({name,email,password}: RegisterDto){
        ...
        // si el usuario crea cuenta en este caso el admin creaa la cuenta no es necesario generar los tokens
    ...
    async login({email, password}: LoginDto){
        ...
        return {access_token, refresh_token, email, message: 'Login Successful'};
    }
