        ...
        <SafeAreaView style={styles.safeArea}>
            ...
            <ScrollView style={styles.container}>
                ...
                <View style={styles.detailsContainer}>
                    ...
                    <ProfileItem icon="briefcase" label="Department" value={profileData.department} editable={isEditing} onChangeText={(text) => setProfileData({...profileData, department: text})} />
                </View>
